...
var _initTodos = require("./initTodos");
document.addEventListener("DOMContentLoaded", (0, _initTodos.initTodos));

},{"./initTodos":"lfY8o"}],"lfY8o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initTodos", ()=>initTodos);
async function initTodos() {
    ...
    async function getPosts(countOfPosts = 10) {
        ...
        let posts = [];
        try {
            const response = await fetch(`https://jsonplaceholder.typicode.com/posts?_limit=${countOfPosts}&_start=2`);
...
},{}]},["gEwwu","1SICI"], "1SICI", "parcelRequirefbf3")
